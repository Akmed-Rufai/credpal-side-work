...
export class WebhooksService {
    ...
    async handlePaystackWebhook(signature: string, rawBody: Buffer, payload: PaystackWebhookDto) {
        ...
        if (!reference || !metadata?.user_id || !metadata?.cohort_id) {
            console.warn('Webhook received without necessary tracking metadata for reference:', reference);
