...
describe('PaymentsService', () => {
    ...
    describe('initializePayment', () => {
        ...
        it('should throw NotFoundException if cohort or program is invalid', async () => {
            ...
            await expect(service.initializePayment(userId, cohortId)).rejects.toThrow(NotFoundException);
        });
        ...
        it('should create a pending transaction and return fake checkout url', async () => {
            ...
            expect(result).toHaveProperty('authorization_url', 'https://checkout.paystack.com/fake');
